  ...
  _helpPage(page) {
    ...
    if (page === '#chrome') {
      mlog(([
        ...
        '',
        'Chrome lets you temporarily bypass the security feature that prevents you from connecting to unprotected WebSockets.',
        '',
    ...
    if (page === '#firefox') {
      mlog(([
        ...
        '',
        'Firefox lets you disable the security feature that prevents you from connecting to unprotected WebSockets.',
        '',
      ]).concat(disclaimer).concat([
        '',
        {
    ...
    if (page === '#unprotected') {
      mlog([
        ...
        [
          ...
          'You can work around the problem by setting up the ',
          {
            type: 'dwstgg',
        ...
        '',
/*
        'You can run DWST locally by executing the following commands in a shell.',
        '',
