...
import {errorHandler, DwstError, NoConnection, AlreadyConnected, SocketError, InvalidParticles, InvalidArgument, InvalidCombination, UnknownCommand, UnknownInstruction, UnknownHelpPage, UnknownText, UnknownBinary, NoInterval} from '../errors.js';
...
describe('errors module', () => {
  ...
  describe('NoInterval error', () => {
    const error = new NoInterval();
    it('should extend DwstError', () => {
      expect(error).to.be.an.instanceof(DwstError);
    });
  });
